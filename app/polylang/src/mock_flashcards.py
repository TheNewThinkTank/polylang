mock_flashcards = {
    ...
    "elephant": """a very large plant-eating mammal with a prehensile trunk,
                   long curved ivory tusks, and large ears
                """,
    "friend": """a person whom one knows
                 and with whom one has a bond of mutual affection
              """,
    "house": """a building for human habitation,
                especially one that is lived in by a family
    ...
    "jacket": """a short coat,
                 ...
                 and made from a thick material,
                 worn as part of one's outfit or as protective clothing
              """,
    "kangaroo": """a large plant-eating marsupial
                   with a long powerful tail
                   and strongly developed hindlimbs
                   that enable it to travel by leaping
                """,
}
